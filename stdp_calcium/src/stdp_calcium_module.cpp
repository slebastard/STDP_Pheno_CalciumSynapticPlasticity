...
/*
 * There are three scenarios, in which STDPCalciumModule can be loaded by NEST:
 *
...
stdpcalcium::STDPCalciumModule stdp_calcium_module_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

stdpcalcium::STDPCalciumModule::STDPCalciumModule()
{
#ifdef LINKED_MODULE
...
const std::string
stdpcalcium::STDPCalciumModule::name( void ) const
{
  return std::string( "Calcium-based STDP Connection" ); // Return name of the module
}

const std::string
stdpcalcium::STDPCalciumModule::commandstring( void ) const
{
  // Instruct the interpreter to load STDPCalciumModule-init.sli
  return std::string( "(stdp_calcium_module-init) run" );
}

//-------------------------------------------------------------------------------------

void
stdpcalcium::STDPCalciumModule::init( SLIInterpreter* i )
{
